<!-- BANNER HEADER -->
<p align="center">
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:FF6B9D,50:00D9FF,100:2C5364&height=220&section=header&text=Yusuf%20Baran%20Y%C4%B1ld%C4%B1z&fontSize=45&fontColor=ffffff&animation=fadeIn&fontAlignY=35"/>
</p>

<!-- ANIMATED TITLE -->
<p align="center">
<img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&size=26&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&width=700&lines=Artificial+Intelligence+Engineer;Machine+Learning+Developer;Python+%7C+Deep+Learning;Data+Science+Enthusiast;Future+AI+Engineer" alt="Typing SVG" />
</p>
...
Yazılım Mühendisliği 4. sınıf öğrencisiyim ve **Yapay Zekâ ve Makine Öğrenmesi** alanında uzmanlaşmaktayım. Veri analizi, derin öğrenme ve gerçek dünya problemlerine AI çözümleri geliştirme konularına odaklanıyorum.

- 🎓 Antalya Belek Üniversitesi - Yazılım Mühendisliği (Tam Burslu)
- 🤖 AI/ML Odaklı Geliştirici
- 📊 Veri Analizi ve Predictive Modeling
- 🔬 Derin Öğrenme Sistemleri
- 🚀 Aktif Proje Geliştiriyorum
- 🎯 AI Engineer Pozisyonu Hedefliyorum
...
## 🎯 AI & Machine Learning Fokusları

```
🧠 Deep Learning (CNN, RNN, Transformers)
📊 Machine Learning (Supervised & Unsupervised)
📈 Data Analysis & Visualization
🤖 Predictive Systems & Automation
🔍 Computer Vision
...
### 🤖 AI Otomasyon Risk Tahmin Sistemi
...
Gerçek dünya verileriyle otomasyon riski tahmin eden ML sistemi.

**Özellikler:**
- Veri ön işleme (Data Preprocessing)
- Makine öğrenmesi modeli eğitimi
- Risk tahmini sistemi
- Detaylı analiz

[🔗 Repository →](https://github.com/YusufBaranYildiz/ai-automation-risk-prediction)

---

### 🎨 Deep Learning Stylist

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![TensorFlow](https://img.shields.io/badge/TensorFlow-FF6F00?style=flat-square&logo=tensorflow&logoColor=white)
![CNN](https://img.shields.io/badge/CNN-purple?style=flat-square)

Derin öğrenme tabanlı görüntü stil analiz ve transferi.

[🔗 Repository →](https://github.com/YusufBaranYildiz/DeepLearningStylist)
...
Yapay zekâ ve veri analizi araştırması.

[🔗 Repository →](https://github.com/YusufBaranYildiz/ai_rep2030)
...
![Web App](https://img.shields.io/badge/Web%20App-blue?style=flat-square)

Antalya Belek Proje Yönetim Uygulaması.

[🔗 Repository →](https://github.com/YusufBaranYildiz/antalya-belek-proje-surec-yonetimi-v0.5)
...
| Okul | Program | Durum |
|------|---------|-------|
| **Antalya Belek Üniversitesi** | Yazılım Mühendisliği (4. Sınıf) | 🎯 Tam Burslu |
| **Sakarya Uygulamalı Bilimler Üniversitesi** | Bilgisayar Destekli Tasarım (Ön Lisans) | ✅ Tamamlandı |

### 🏅 Profesyonel Sertifikalar

<details open>
<summary><b>⭐ 2024-2026 Sertifikaları</b></summary>

🏆 **CISCO AI Fundamentals with IBM SkillsBuild** *(2025)*  
🏆 **CISCO Data Science Essentials With Python** *(2026)*  
🏆 **İstanbul Büyükşehir Deep Learning Atölyesi** *(2025)*  
🏆 **GARANTİ BBVA Makine Öğrenmesi Programı** *(2025)*  
🏆 **GARANTİ BBVA Gen AI Teknoloji Serisi** *(2025)*  
🏆 **İstanbul Büyükşehir Makine Öğrenmesi Bootcamp** *(2026)*  
...
✅ Gerçek dünya AI uygulamaları üzerinde çalışma
✅ AI Engineer pozisyonu elde etme
```
...
<!-- FOOTER BANNER -->
<p align="center">
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:2C5364,50:00D9FF,100:FF6B9D&height=120&section=footer&text=Happy%20Coding%20🚀&textBg=false&fontSize=20&fontColor=ffffff"/>
</p>

<p align="center">
<strong>⭐ Projelerimden birini beğendiysen bir star vermeyi unutma!</strong>  
<br/>
<em>Made with ❤️ by Yusuf Baran YILDIZ</em>
</p>
